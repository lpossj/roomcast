> 2026-09-26T22:15:49+08:00 新状态：用户已将目标改为异常操作可停止与第一次X直接退出；最终实现/每步时间戳见 [EXIT-CANCEL-20260926.md](EXIT-CANCEL-20260926.md)。版本仍beta.6，本地重打包，未push/tag/Release。下文属于历史快照，2.5秒预算和App与beta.5逐字节相同不能作为当前包结论。
