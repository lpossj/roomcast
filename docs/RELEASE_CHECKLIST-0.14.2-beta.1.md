# Roomcast 0.14.2-beta.1 Beta Release Checklist

## 1. 源码和版本

- [ ] package.json version = 0.14.2-beta.1
- [ ] package-lock.json version = 0.14.2-beta.1
- [ ] README / docs 版本号 = 0.14.2-beta.1
- [ ] 发布说明定位为公开测试版（Beta）
- [ ] 没有残留旧版本 rc 源码引用
...
- [ ] release/Roomcast-0.14.2-beta.1-Windows.exe 存在
- [ ] release/Roomcast-0.14.2-beta.1-Windows.zip 存在
- [ ] release/Roomcast-0.14.2-beta.1-source.zip 存在
- [ ] release/Roomcast-0.14.2-beta.1-loopback-capture.zip 存在
...
本轮已在干净 Windows 10/11 x64 环境完成以下验收。除版本号和发布文档外，运行时与代码基线与本次 Beta 相同；重新打包后建议至少抽查启动和创建房间：
...
```text
Roomcast 0.14.2-beta.1 公开测试版（Beta）发布。
Windows 10/11 x64。
